...
bool GameScene::init()
{
    ...
    edgeBody->setCollisionBitmask(OBTACLE_COLLISION_BITMASK);
...
bool GameScene::onContactBegin(cocos2d::PhysicsContact &contact){
    ...
    if( ( BIRD_COLLISION_BITMASK == a->getCollisionBitmask() && OBTACLE_COLLISION_BITMASK == b->getCollisionBitmask())
     ||( BIRD_COLLISION_BITMASK == b->getCollisionBitmask() && OBTACLE_COLLISION_BITMASK == a->getCollisionBitmask())){
