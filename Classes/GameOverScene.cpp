...
bool GameOverScene::init()
{
    ...
    auto retryItem = MenuItemFont::create("Retry again", CC_CALLBACK_1(GameOverScene::GoToGameScene, this));
    retryItem->setPosition(Point(visibleSize.width /2 + origin.x , visibleSize.height / 4 * 3  ));

    auto mainMenuItem = MenuItemFont::create("Main Menu", CC_CALLBACK_1(GameOverScene::GoToMainMenuScene, this));
    ...
    currentScore->setPosition(Point(visibleSize.width * 0.25 , visibleSize.height / 2 + origin.y ));
    ...
    highScoreLabel->setPosition(Point(visibleSize.width * 0.75 , visibleSize.height / 2 + origin.y ));
